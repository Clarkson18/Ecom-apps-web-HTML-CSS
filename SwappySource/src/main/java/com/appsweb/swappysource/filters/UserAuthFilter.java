 ...
 * @author vv094
 */
@WebFilter(filterName = "UserAuthFilter", urlPatterns = { "/cambiarContrasena.jsp",
        "/carrito.jsp",
        "/perfil.jsp"
})
public class UserAuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (isUser(usuario) || isUser(usuarioLogueado)) {
    ...
    private boolean isUser(Object user) {
        if (user == null) {
            return false;
        }
        if (user instanceof UsuarioLogueadoDTO) {
            UsuarioLogueadoDTO dto = (UsuarioLogueadoDTO) user;
            return dto.getRol().equals(Rol.CLIENTE);
        }
        if (user instanceof Usuario) {
            Usuario u = (Usuario) user;
            return u.getRol().equals(Rol.CLIENTE);
        }
        return false;
    }
