...
<html lang="es">
    <head>
        ...
        <script>
            window.API_BASE = "<%= request.getContextPath()%>/resources";  // AQUI<---
        </script>
        <script defer src="<%= request.getContextPath()%>/scripts/carrito.js"></script> <!-- AQUI<--- -->

        <style>
            :root{
                --brand:#16a34a;
                --header:#EAF9E6;
                --header-border:#CDEFC5;
                --panel:#F1F2F4;
                --panel-soft:#F6F7F8;
                --text:#0b0f10;
                --muted:#6b7280;
            ...
            <section class="grid">
                ...
                <aside>
                    <div class="summary">
                        ...
                        <div class="line">
                            <span>Subtotal (<span id="subtotalCount">0</span> productos):</span> 
                            <strong id="subtotalMonto">$0.00</strong> 
                        </div>

                        <div class="line">
                            <span>Envío:</span>
                            <strong id="envioMonto">$0.00</strong>
                        </div>

                        <div class="line">
                            <span>IVA (Aplicable):</span>
                            <strong id="ivaMonto">$0.00</strong> 
                        </div>

                        <div class="line">
                            <span>Total:</span>
                            <strong id="totalMonto">$0.00</strong> 
                        </div>

                        <div class="pay">
                            <button type="button" id="btnPagar">Proceder al Pago</button> 
                        </div>
                    </div>
