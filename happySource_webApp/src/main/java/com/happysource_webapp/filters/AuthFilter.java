 ...
 */
package com.happysource_webapp.filters;
...
public class AuthFilter implements Filter {
    ...
    private String getPathSolicitado(HttpServletRequest request){
        ...
        //el context path nos quita el apartado de dominio 
    ...
    //uso de whitelist
    public boolean  isURLPrivate(String path){
    
        for(String publicPath:this.PUBLIC_PATHS){
    ...
    private boolean isUserLogged(HttpServletRequest request){
        ...
        boolean isLogged = (session !=null && session.getAttribute(SESSION_KEY) != null );
        return true;
    }
    /**
     *
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            boolean isUserLogged = this.isUserLogged(requestOriginal);
            if(!isUserLogged && isURLPrivate){
